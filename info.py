...
FILE_LIMITE = int(environ.get('FILE_LIMITE', False))
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://<db_username>:kmqOtPGyDd6jSnVz@cluster0.3x2nt.mongodb.net/?retryWrites=true&w=majority")
